...
```mermaid
flowchart TD
    A["Open the actual statements<br/>and notes, name entity,<br/>period, framework"] --> B["Name the governing framework<br/>and its current effective version"]
    B --> C["Recompute load-bearing arithmetic:<br/>totals reconcile, ratios, allocations"]
    C --> D{"Recognition checked against<br/>the standard — revenue timing<br/>(IFRS 15 five steps)?"}
    D -->|"no"| E["Flag premature recognition<br/>or wrong measurement"]
    D -->|"yes"| F["Read notes + auditor's report:<br/>related parties, going concern,<br/>estimates, off-balance-sheet"]
    E --> F
    F --> G["State the boundary:<br/>analysis, not audit opinion,<br/>not investment advice"]
    G --> H["Report outcome-first,<br/>figures line-cited,<br/>unverifiable items listed"]
```
...
- ACFE, Occupational Fraud 2024: A Report to the Nations (organizations lose about 5% of revenue to fraud each year; financial statement misstatement carries the highest median loss, $766,000): https://www.acfe.com/fraud-resources/report-to-the-nations-archive (accessed 2026-08-15); press release: https://www.acfe.com/about-the-acfe/newsroom-for-media/press-releases/press-release-detail?s=2024-Report-to-the-Nations (accessed 2026-08-15)
