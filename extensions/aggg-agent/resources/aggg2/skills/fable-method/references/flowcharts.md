...
flowchart TD
    ...
    DOM -->|"marketing, research, data,<br/>business, finance, financial reporting,<br/>legal, design, devops"| ADAPT["Load the domain adapter.<br/>Its minimum evidence set is binding"]
    ADAPT --> LOOP2
