# AI-writing patterns (Wikipedia: Signs of AI writing) — полный справочник

33 признака AI-текста с примерами и что с ними делать. Источник:
Wikipedia:Signs of AI writing (WikiProject AI Cleanup). Используется
хуманизатором ai-copywriter при аудите текста.
