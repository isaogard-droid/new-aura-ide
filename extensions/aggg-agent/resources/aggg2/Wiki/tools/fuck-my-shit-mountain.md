...
description: "Скилл для Codex, Claude Code, Copilot, Gemini: честная проверка проекта вместо похвалы; профиль репо, отчёт с уликами (severity/confidence/evidence/impact/fix), 25 режимов (security, ai-safety, testing-authenticity — «зелёные, но фейковые тесты», cost, accessibility...); Markdown/HTML с баллами 0-10."
date: 2026-08-11
tags: [tools, skill, code-review, audit, testing]
