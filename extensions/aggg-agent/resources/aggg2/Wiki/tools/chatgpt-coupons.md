...
description: "Промпт для агента ChatGPT: поиск промокодов через поисковики и купонные сайты, заход в магазин, добавление тестового товара, проверка кодов в корзине по одному, отчёт о рабочих кодах и ограничениях."
date: 2026-08-11
tags: [tools, prompts, shopping, ai, coupons]
status: stable
generated:
