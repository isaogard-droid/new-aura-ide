...
description: "Локальный прокси с UI: 82+ модели, 0₽; ключи от 12+ провайдеров (Mistral, Groq, Cerebras, SambaNova, NVIDIA, OpenRouter, GitHub tokens, Cohere, Cloudflare, Google AI Studio, BigModel, Pollinations); роутинг, fallback при 429, слежение за квотами; OpenAI-совместимый; для Pi CLI, Claude Code, Cursor и др."
date: 2026-08-11
tags: [tools, llm, proxy, api, free]
