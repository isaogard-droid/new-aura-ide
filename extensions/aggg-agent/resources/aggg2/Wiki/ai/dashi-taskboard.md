...
description: "Канбан-доска для Codex: создание задач, отслеживание статусов, передача агенту на выполнение; HTTP API, CLI taskctl и Codex Skill (in_progress → работа → in_review → done после подтверждения пользователя)."
date: 2026-08-11
tags: [ai, agents, task-management, kanban, codex]
