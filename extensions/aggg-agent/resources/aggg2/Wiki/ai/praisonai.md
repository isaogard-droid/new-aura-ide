...
description: "Открытый фреймворк для разработчика: агент за 5 строк кода, команды (AgentTeam), workflow (AgentFlow), веб-API (AgentOS); память, RAG, self-reflection, 140+ тулов, MCP, 100+ LLM-провайдеров; 4 уровня входа от SDK до no-code."
date: 2026-08-11
tags: [ai, agents, framework, python, multi-agent]
