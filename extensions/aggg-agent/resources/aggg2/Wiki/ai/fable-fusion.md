...
description: "Qwen3.6-27B Fable-Fusion-711: мультимодальный fine-tune с упором на reasoning и tool calling; GGUF-кванты 12–17 ГБ; ARC-C 0.711 (8-bit) / 0.701 (4-bit); контекст до 262K; vision + tool calling; доработка против отказов (Heretic/abliteration); для локальных агентных сценариев."
date: 2026-08-11
tags: [ai, llm, local, reasoning, qwen]
