...
description: "Совет по вайбкодингу: попросить Codex создать интерактивную карту репозитория (docs/codemap/codemap.html + .json + .lock) и отмечать изменения; полный промпт внутри поста; правило для AGENTS.md о синхронизации карты."
date: 2026-08-11
tags: [coding, agents, prompts, visualization, workflow]
status: stable
generated:
